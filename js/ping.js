...
$(".key").on("touchstart mousedown", "i", function(e) {
  var id = e.target.id;
  switch (id) {
    case 'left':
      leftPressed1 = true;
...
$(".key").on("touchend mouseup", "i", function(e) {
  var id = e.target.id;
  switch (id) {
    case 'left':
      leftPressed1 = false;
...
$(".key").on("touchstart mousedown", "p", function(e) {
  var id = e.target.id;
  switch (id) {
    case 'q':
      leftPressed2 = true;
...
$(".key").on("touchend mouseup", "p", function(e) {
  var id = e.target.id;
  switch (id) {
    case 'q':
      leftPressed2 = false;
